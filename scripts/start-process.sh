...
sudo docker run -d -p 443:443 --name gamingpe-website -v /home/ec2-user/ssl:/etc/nginx/conf.d/ssl 376129854991.dkr.ecr.ap-south-1.amazonaws.com/gamingpe-website:latest
