...
import { testimonials, settings } from "../../mockData/VisionSliderData";
import OurVisionSlider from "./utils/OurVisionSlider";

const OurVisionTestimonials = () => {
  const { title, description } = sectionData.Visiontestimonials;
...
export default OurVisionTestimonials;
